...
export const mathForLittleThinkersBook: Book = {
  slug: "math-for-little-thinkers",
  title: "Math for Little Thinkers",
  subtitle: "The Math Hour",
  summary:
    "The math hour at the table is the whole program: counters or a line, a question worth waiting for, a number sentence they write. A parent who is not a mathematician can run that hour for five-to-ten — counting, the equal sign, equal groups, fractions on a line — if 1/2 + 1/3 = 2/5 is heard as a size mistake, not a cute slip.",
  editorialPrinciple:
    "Place by skill, not by birthday. The child holds the pencil. You hold the key. The guide, if any, waits.",
  chronology: "2026",
  totalWordTarget: "~69,000 words",
  readingTime: "~4.5 hours · 207 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/math-for-little-thinkers-cover.jpg",
  pdfHref: "/downloads/math-for-little-thinkers.pdf",
  epubHref: "/downloads/math-for-little-thinkers.epub",
  mdHref: "/downloads/math-for-little-thinkers.md",
  catalogSubject: "math",
  academySubject: "math",
  hubHref: "/subjects/math",
  hubLabel: "Mathematics subject hub",
  ...
  sittingsDek:
    "Little math sittings are the shorter path: estimate first, path on paper, catch the machine. This book is the kitchen-table hour those sittings sit inside.",
  showBooklets: false,
  figures: [
    {
      slug: "parent-teacher",
      ...
      dates: "now",
      tradition: "Math hour",
      coreQuestion: "Can you hear a size mistake?",
      distinctiveVoice: "One adult, two ages at one table — not a math department down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the math hour still for at five to ten?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    ...
    { number: 4, label: "Chapter 1", title: "Counting and number sense", question: "What is counting, if reciting to 100 is not number sense?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Place value", question: "Can they hear tens and ones as size, not as digits in a row?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Addition, subtraction, and the equal sign", question: "Is 8 + 4 = ☐ + 5 twelve, or a balance?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Fluency", question: "Is a timed worksheet the first fluency move?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Equal groups", question: "What is multiplication before a times table?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Fractions as numbers", question: "Is a pizza drawing the number 3/4?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Measurement, time, and money", question: "Can they measure, tell time, and count money as number?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Shapes, early data, and story problems", question: "What is a story problem if “altogether” is glued to addition?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
};

export const mathForYoungMindsBook: Book = {
  slug: "math-for-young-minds",
  title: "Math for Young Minds",
  subtitle: "The Math Hour",
  summary:
    "The math hour at the table is the whole program: a ratio table or a number line that runs both ways, a question worth waiting for, an equation they write and check. A parent who is not a mathematician can run that hour for eleven-to-fourteen — fractions as numbers, ratio, signed numbers, expressions, equations — if cross-multiply with no table is heard as a missing-meaning move, not a cute slip.",
  editorialPrinciple:
    "Place by skill, not by birthday. The student holds the pencil. You hold the key. The guide, if any, waits.",
  chronology: "2026",
  totalWordTarget: "~58,000 words",
  readingTime: "~4 hours · 188 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/math-for-young-minds-cover.jpg",
  pdfHref: "/downloads/math-for-young-minds.pdf",
  epubHref: "/downloads/math-for-young-minds.epub",
  mdHref: "/downloads/math-for-young-minds.md",
  catalogSubject: "math",
  academySubject: "math",
  hubHref: "/subjects/math",
  hubLabel: "Mathematics subject hub",
  sittingsHeading: "Practice the path in the academy",
  sittingsDek:
    "Young math sittings are the shorter path: estimate first, path on paper, catch the machine. This book is the kitchen-table hour for eleven-to-fourteen those sittings sit inside.",
  showBooklets: false,
  figures: [
    {
      slug: "parent-teacher",
      ...
      dates: "now",
      tradition: "Math hour",
      coreQuestion: "Can you hear a missing-meaning move?",
      distinctiveVoice: "One adult, two grains at one table — not a math department down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the math hour still for at eleven to fourteen?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The Math Hour", question: "What does a session of number actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "Fractions, decimals, and percents as numbers", question: "Are fractions, decimals, and percents the same number, including negatives?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Ratio and proportion", question: "What is a ratio table for, if cross-multiply is not meaning?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Integers and signed numbers", question: "Is pizza the number −3/4?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Expressions", question: "What is structure, if letter-moving is not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Equations", question: "Same to both sides — or write the answer after the equals?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Early functions and linear thinking", question: "What is a function before a formula card?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Geometry with reasons", question: "Is a formula card geometry?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Data, chance, and story problems", question: "What does a story problem look like when the schema is named?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
};
...
export const mathRefresherForAdultsBook: Book = {
  ...
  subtitle: "The Refresh Hour",
  summary:
    "Usable mathematics is ordinary adult work: a number on a line, a unit price on a shelf, a percent on a dashboard, a short reason for a measurement. A working adult who is not a mathematician can run that hour on a train, at a desk, on a shift — if “of means multiply” is heard as a keyword grab, not a schema, and a calculator output is not allowed to pass as sense.",
  editorialPrinciple:
    "Adulthood is not a math birthday. Practice on the number in front of you. You hold the account; the guide, if any, waits.",
  chronology: "2026",
  totalWordTarget: "~52,000 words",
  readingTime: "~3.5 hours · 167 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/math-refresher-for-adults-cover.jpg",
  pdfHref: "/downloads/math-refresher-for-adults.pdf",
  epubHref: "/downloads/math-refresher-for-adults.epub",
  mdHref: "/downloads/math-refresher-for-adults.md",
  catalogSubject: "math",
  academySubject: "math",
  hubHref: "/subjects/math",
  hubLabel: "Mathematics subject hub",
  sittingsHeading: "Practice the path in the academy",
  sittingsDek:
    "Adult math sittings are the shorter path. This book is the refresh hour those sittings sit inside — commute, desk, shift — not a second Mathematics for Homeschooling.",
  showBooklets: false,
  figures: [
    {
      slug: "parent-teacher",
      name: "The working adult",
      dates: "now",
      tradition: "Refresh hour",
      coreQuestion: "Can you hear a keyword percent that is not yet a schema?",
      distinctiveVoice: "You, holding the account — not a math department down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the refresh hour still for?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The Refresh Hour", question: "What does a session of usable mathematics actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "Number sense, fractions, and decimals as numbers", question: "Are fractions and decimals numbers you can place?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Percent and ratio", question: "Is “of means multiply” a schema, or a keyword grab?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Algebra refresh", question: "What is structure, if letter-moving is not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Geometry with reasons", question: "Is a formula with no reason geometry?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Functions and trigonometry", question: "What is a function before a formula card?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Calculus edges", question: "What still has to mean, at the edge of calculus?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Statistics for life and work", question: "Is a sample mean a population claim?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
...
export const englishForEmergingAdultsBook: Book = {
  slug: "english-for-emerging-adults",
  title: "English for Emerging Adults",
  subtitle: "The English Hour",
  summary:
    "The English hour at the table is the whole program: a word stripped into parts, a dense page with one scaffold, a claim with evidence and a warrant, a seminar turn, a draft they revise for one named target. A parent who is not a reading specialist can run that hour for fifteen-to-eighteen — if an AR quiz is not allowed to pass as comprehension, AP is not allowed to pass as the only honest path, and a chatbot is not allowed to pass as the essay partner.",
  editorialPrinciple:
    "Place by skill, not by birthday. The student holds the pencil. You hold the key. The guide, if any, waits. Do not finish the paragraph.",
  chronology: "2026",
  totalWordTarget: "~64,000 words",
  readingTime: "~4.5 hours · 220 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/english-for-emerging-adults-cover.jpg",
  pdfHref: "/downloads/english-for-emerging-adults.pdf",
  epubHref: "/downloads/english-for-emerging-adults.epub",
  mdHref: "/downloads/english-for-emerging-adults.md",
  catalogSubject: "english",
  academySubject: "english",
  hubHref: "/subjects/english",
  hubLabel: "English subject hub",
  ...
  figures: [
    {
      ...
      dates: "now",
      tradition: "English hour",
      coreQuestion: "Can you hear a chatbot offered as the essay partner?",
      distinctiveVoice: "One adult, a late-high-school student at the table — not a literacy department down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the English hour still for at fifteen to eighteen?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The English Hour", question: "What does a session of reading and writing actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "Academic language, morphology, and code repair by skill", question: "Is phonics over when multisyllabic decoding still collapses?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Complex text: volume, scaffolds, and close reading", question: "Can they stay with a dense page with one scaffold?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Literary reading", question: "Is live controversy the literature curriculum?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Informational reading and rhetoric", question: "Can they name a warrant beside a claim?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Seminar discussion and speaking/listening", question: "Can a person in the room hear them take a turn?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Writing to argue, explain, and narrate", question: "Whose draft is it, and what is the named target?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Research and citation", question: "Did they open the source?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Grammar, style, and revision in service of meaning", question: "Is a grammar pack the writing program?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
};

export const englishForAdultsBook: Book = {
  slug: "english-for-adults",
  title: "English for Adults",
  subtitle: "The Refresh Hour",
  summary:
    "Usable literacy is ordinary adult work: a word that yields to its parts, a paragraph whose job you can name, a claim with evidence and a warrant, an email that leads with the ask. A working adult who is not a novelist can run that hour on a train, at a desk, on a shift — if highlight-and-hope is not allowed to pass as comprehension, and a chatbot rewrite is not allowed to pass as your only draft.",
  editorialPrinciple:
    "Adulthood is not a literacy birthday. Practice on the text in front of you. You hold the account; the guide, if any, waits.",
  chronology: "2026",
  ...
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/english-for-adults-cover.jpg",
  pdfHref: "/downloads/english-for-adults.pdf",
  epubHref: "/downloads/english-for-adults.epub",
  mdHref: "/downloads/english-for-adults.md",
  catalogSubject: "english",
  academySubject: "english",
  hubHref: "/subjects/english",
  hubLabel: "English subject hub",
  ...
  figures: [
    {
      ...
      dates: "now",
      tradition: "Refresh hour",
      coreQuestion: "Can you hear a finished-looking rewrite offered as your only draft?",
      distinctiveVoice: "You, holding the account — not a literacy department down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the refresh hour still for?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The Refresh Hour", question: "What does a session of usable literacy actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "Academic vocabulary and morphology", question: "Does the word yield to its parts?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Reading complex text", question: "Is highlight-and-hope comprehension?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Rhetoric: claim, evidence, warrant", question: "Can you hear a claim without a warrant?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Workplace and civic writing", question: "Does the email lead with the ask?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Literary and informational reading", question: "Can two lines defend a reading?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Research edges and open-the-source citation", question: "Is a quote-mine research?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Grammar, style, and revision", question: "Did meaning change before commas were tidied?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Keeping track", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
};
...
export const englishForYoungThinkersWithDyslexiaBook: Book = {
  slug: "english-for-young-thinkers-with-dyslexia",
  title: "English for Young Thinkers with Dyslexia",
  subtitle: "The English Hour (Structured Literacy for Ages 5–10)",
  summary:
    "A teaching manual for English with a five- to ten-year-old who finds word reading and spelling unexpectedly hard. It does not diagnose. It teaches a parent how to run Structured Literacy intensity at that table — if “wait, they’ll catch up,” colored overlays, and a leveled ladder are not allowed to pass as the intervention.",
  editorialPrinciple:
    "Ages 5–10 only. Place by skill, not by birthday. Short sharp sits. The child holds the pencil. You hold the key. The guide, if any, waits.",
  chronology: "2026",
  totalWordTarget: "~69,000 words",
  readingTime: "~5.5 hours · 259 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/english-for-young-thinkers-with-dyslexia-cover.jpg",
  pdfHref: "/downloads/english-for-young-thinkers-with-dyslexia.pdf",
  epubHref: "/downloads/english-for-young-thinkers-with-dyslexia.epub",
  mdHref: "/downloads/english-for-young-thinkers-with-dyslexia.md",
  catalogSubject: "english",
  academySubject: "english",
  hubHref: "/subjects/english",
  hubLabel: "English subject hub",
  ...
  figures: [
    {
      ...
      dates: "now",
      tradition: "Structured literacy",
      coreQuestion: "Can you hear “wait — they’ll catch up” offered as the intervention?",
      distinctiveVoice: "One adult, ages 5–10 at the table — not a reading clinic down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the Structured Literacy hour still for at five to ten?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The English Hour (Structured Literacy for Ages 5–10)", question: "What does a session of Structured Literacy actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "What dyslexia looks like at 5–10", question: "Is this a diagnosis, or a teaching profile?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Phonemic awareness with letters", question: "Can they hear the sound with a letter in hand?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Phonics and decoding", question: "Is a leveled ladder decoding?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Encoding and spelling", question: "Can they write the word they just read?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Decodable connected reading and fluency after accuracy", question: "Is a stopwatch the first fluency move?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Vocabulary, morphology-light, and comprehension on accessible text", question: "Is “just read more” comprehension?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Early writing with adaptations", question: "Can they write without abandoning spelling?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Short assessments and progress checks", question: "What did today’s errors teach tomorrow?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
};

export const englishForYoungMindsWithDyslexiaBook: Book = {
  slug: "english-for-young-minds-with-dyslexia",
  title: "English for Young Minds with Dyslexia",
  subtitle: "The English Hour (Structured Literacy for Ages 11–14)",
  summary:
    "A teaching manual for English with an eleven- to fourteen-year-old who finds word reading and spelling unexpectedly hard. It does not diagnose. It teaches a parent how to run Structured Literacy intensity at that table — if “phonics is over at 11,” AR points, and a baby-decodable book are not allowed to pass as the intervention.",
  editorialPrinciple:
    "Ages 11–14 only. Age does not retire decoding. Short sharp sits. The student holds the pencil. You hold the key. The guide, if any, waits.",
  chronology: "2026",
  totalWordTarget: "~60,000 words",
  readingTime: "~5 hours · 226 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/english-for-young-minds-with-dyslexia-cover.jpg",
  pdfHref: "/downloads/english-for-young-minds-with-dyslexia.pdf",
  epubHref: "/downloads/english-for-young-minds-with-dyslexia.epub",
  mdHref: "/downloads/english-for-young-minds-with-dyslexia.md",
  catalogSubject: "english",
  academySubject: "english",
  hubHref: "/subjects/english",
  hubLabel: "English subject hub",
  ...
  figures: [
    {
      ...
      dates: "now",
      tradition: "Structured literacy",
      coreQuestion: "Can you hear “phonics is over at 11” when the code is not finished?",
      distinctiveVoice: "One adult, ages 11–14 at the table — not a reading clinic down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the Structured Literacy hour still for at eleven to fourteen?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The English Hour (Structured Literacy for Ages 11–14)", question: "What does a session of Structured Literacy actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "What dyslexia looks like at 11–14", question: "Is this a diagnosis, or a teaching profile?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Multisyllabic decoding repair", question: "Is the code finished because they are eleven?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Encoding and spelling", question: "Can they write the word they just read?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Morphology denser in text", question: "Do the parts of the word still mean?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Fluency after accuracy", question: "Is a stopwatch the first fluency move?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Vocabulary in use and comprehension on accessible text", question: "Are AR points comprehension?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Writing with adaptations", question: "Can they write without abandoning spelling and sentence craft?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Short assessments and progress checks", question: "What did today’s errors teach tomorrow?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
...
export const englishForEmergingAdultsWithDyslexiaBook: Book = {
  slug: "english-for-emerging-adults-with-dyslexia",
  title: "English for Emerging Adults with Dyslexia",
  subtitle: "The English Hour (Structured Literacy for Ages 15–18)",
  summary:
    "A teaching manual for English with a fifteen- to eighteen-year-old who finds word reading and spelling unexpectedly hard. It does not diagnose. It teaches a parent how to run Structured Literacy intensity at that table — if “phonics is over in high school,” wait-until-college, and “just read more” are not allowed to pass as the intervention.",
  editorialPrinciple:
    "Ages 15–18 only. Age does not retire decoding. Short sharp sits. The student holds the pencil. You hold the key. The guide, if any, waits.",
  chronology: "2026",
  totalWordTarget: "~62,000 words",
  readingTime: "~5 hours · 229 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/english-for-emerging-adults-with-dyslexia-cover.jpg",
  pdfHref: "/downloads/english-for-emerging-adults-with-dyslexia.pdf",
  epubHref: "/downloads/english-for-emerging-adults-with-dyslexia.epub",
  mdHref: "/downloads/english-for-emerging-adults-with-dyslexia.md",
  catalogSubject: "english",
  academySubject: "english",
  hubHref: "/subjects/english",
  hubLabel: "English subject hub",
  ...
  figures: [
    {
      ...
      dates: "now",
      tradition: "Structured literacy",
      coreQuestion: "Can you hear “phonics is over in high school” when the code is not finished?",
      distinctiveVoice: "One adult, ages 15–18 at the table — not a reading clinic down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the Structured Literacy hour still for at fifteen to eighteen?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The English Hour (Structured Literacy for Ages 15–18)", question: "What does a session of Structured Literacy actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "What dyslexia looks like at 15–18", question: "Is this a diagnosis, or a teaching profile?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Multisyllabic decoding repair", question: "Is the code finished because they are in high school?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Encoding and spelling", question: "Can they write the word they just read?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Morphology denser in HS text", question: "Do the parts of the word still mean in this page?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Fluency after accuracy", question: "Is a stopwatch the first fluency move?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Vocabulary in use and comprehension on accessible text", question: "Is “just read more” comprehension?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Writing and research with adaptations", question: "Can they write and open a source without abandoning the code?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Short assessments and progress checks", question: "What did today’s errors teach tomorrow?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
...
export const historyForLittleThinkersBook: Book = {
  slug: "history-for-little-thinkers",
  title: "History for Little Thinkers",
  subtitle: "The History Hour",
  summary:
    "The history hour at the table is the whole program: a piece from then before the story, who made this before the caption, one good question you wait for. A parent who is not a historian can run that hour for five-to-ten — pictures, objects, oral history, maps as place — if a generated diary is not allowed to pass as a source.",
  editorialPrinciple:
    "Place by skill, not by birthday. Piece-from-then before story. Who made this. The guide, if any, waits.",
  chronology: "2026",
  totalWordTarget: "~53,000 words",
  readingTime: "~4 hours · 192 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/history-for-little-thinkers-cover.jpg",
  pdfHref: "/downloads/history-for-little-thinkers.pdf",
  epubHref: "/downloads/history-for-little-thinkers.epub",
  mdHref: "/downloads/history-for-little-thinkers.md",
  catalogSubject: "history",
  academySubject: "history",
  hubHref: "/subjects/history",
  hubLabel: "History subject hub",
  ...
  figures: [
    {
      ...
      tradition: "History hour",
      coreQuestion: "Who made this?",
      distinctiveVoice: "One adult, two ages at one table — not a history department down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the history hour still for at five to ten?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The History Hour", question: "What does a session with one piece from then actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "What history looks like at 5–10", question: "Is a date list the work?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Objects, pictures, and “who made this”", question: "Can they ask who made this before the caption?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Family and community oral history", question: "Whose memory is on the table?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Maps as pictures and place", question: "Is the map a picture of a place, or a coloring sheet?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Timeline light", question: "Can three pictures hang in order?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Holidays and commemorations with care", question: "Is a holiday a story, or a source?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Talking and writing history", question: "Whose sentence is the exit crumb?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
...
export const historyForYoungMindsBook: Book = {
  slug: "history-for-young-minds",
  title: "History for Young Minds",
  subtitle: "The History Hour",
  summary:
    "The history hour at the table is the whole program: a named source before the tidy summary, who-when-for-whom before the body, two accounts when the week needs them. A parent who is not a historian can run that hour for eleven-to-fourteen — if a textbook-as-the-facts answer and a model summary are not allowed to pass as the source.",
  editorialPrinciple:
    "Source before summary. Place by skill, not by birthday. Early civic texts as documents, not slogans.",
  chronology: "2026",
  totalWordTarget: "~54,000 words",
  readingTime: "~4 hours · 183 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/history-for-young-minds-cover.jpg",
  pdfHref: "/downloads/history-for-young-minds.pdf",
  epubHref: "/downloads/history-for-young-minds.epub",
  mdHref: "/downloads/history-for-young-minds.md",
  catalogSubject: "history",
  academySubject: "history",
  hubHref: "/subjects/history",
  hubLabel: "History subject hub",
  ...
  figures: [
    {
      ...
      dates: "now",
      tradition: "History hour",
      coreQuestion: "Who made this, when, and for whom?",
      distinctiveVoice: "The adult who hears a summary-first answer — not a year, not a chatbot.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the history hour still for at eleven to fourteen?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The History Hour", question: "What does a session with one named source actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "What history looks like at 11–14", question: "Is a year-first quiz the work?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Reading a source", question: "Can they cover the body until who-when-why is said?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Two sources and corroboration", question: "Can two accounts of one event sit on the same table?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Context without drowning", question: "Is context a lecture, or a limit?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Early civic texts gently", question: "Is the excerpt a document, or a slogan?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Maps, timelines, and place", question: "Does the map serve a story they already own?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Talking and writing history", question: "Does the claim point at a named source?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Short assessments and progress checks", question: "What did today’s looking teach tomorrow?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
...
export const historyForEmergingAdultsBook: Book = {
  slug: "history-for-emerging-adults",
  title: "History for Emerging Adults",
  subtitle: "The History Hour",
  summary:
    "The history hour at the table is the whole program: a named founding document before the tidy story, who-when-for-whom-against-what-problem before the body, then-words before now-lectures. A parent who is not a historian can run that hour for fifteen-to-eighteen — if an AP binder, an encyclopedia of years, or a fluent review-book paragraph is not allowed to pass as looking.",
  editorialPrinciple:
    "The Constitution chain as documents with makers. Coverage is a map. Depth is the hour. Not a campaign speech.",
  chronology: "2026",
  totalWordTarget: "~56,000 words",
  readingTime: "~4 hours · 190 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/history-for-emerging-adults-cover.jpg",
  pdfHref: "/downloads/history-for-emerging-adults.pdf",
  epubHref: "/downloads/history-for-emerging-adults.epub",
  mdHref: "/downloads/history-for-emerging-adults.md",
  catalogSubject: "history",
  academySubject: "history",
  hubHref: "/subjects/history",
  hubLabel: "History subject hub",
  ...
  figures: [
    {
      ...
      dates: "now",
      tradition: "History hour",
      coreQuestion: "Who made this, when, for whom, against what problem?",
      distinctiveVoice: "The adult who hears a founding line offered as campaign speech.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the history hour still for at fifteen to eighteen?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to use this book", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If you only remember five things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The History Hour", question: "What does a session with one founding excerpt actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "What history looks like at 15–18", question: "Is an encyclopedia of years the hour?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Reading a founding document", question: "Can they cover the body until who-when-for-whom is said?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "From problem to structure", question: "What problem was the maker answering?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Rights and limits", question: "Is a right a slogan, or a limit in a document?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Argument across the aisle", question: "Can two voices sit on the same table?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Context, maps, and timelines at high school", question: "Does the map serve today’s excerpt?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Talking and writing civic history", question: "Does the claim point at named text?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Short assessments and progress checks", question: "What did today’s looking teach tomorrow?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Records", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 13, label: "Chapter 10", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
...
export const historyRefreshForAdultsBook: Book = {
  slug: "history-refresh-for-adults",
  title: "History Refresh for Adults",
  subtitle: "The History Refresh Hour",
  summary:
    "Usable civic literacy is ordinary adult work: a feed card, a ballot pamphlet, a plaque, a short civic excerpt with a credit line. A working adult who is not a historian can run that hour on a train or after the kids are in bed — if a caption is not allowed to pass as the event, and a model précis is not allowed to pass as a primary.",
  editorialPrinciple:
    "Primary before feed. Source before body. A short claim with a named source and a named limit. Adulthood is not a civic birthday.",
  chronology: "2026",
  totalWordTarget: "~51,000 words",
  readingTime: "~3.5 hours · 170 pages",
  authors: ["Michael Gannotti"],
  status: "published",
  audiobookPlanned: true,
  coverImage: "/images/books/history-refresh-for-adults-cover.jpg",
  pdfHref: "/downloads/history-refresh-for-adults.pdf",
  epubHref: "/downloads/history-refresh-for-adults.epub",
  mdHref: "/downloads/history-refresh-for-adults.md",
  catalogSubject: "history",
  academySubject: "history",
  hubHref: "/subjects/history",
  hubLabel: "History subject hub",
  ...
  figures: [
    {
      ...
      name: "The working adult",
      dates: "now",
      tradition: "History refresh hour",
      coreQuestion: "Can you hear a caption offered as the event?",
      distinctiveVoice: "You, holding the piece — not a civic department down the hall.",
    },
  ],
  chapters: [
    { number: 0, label: "Welcome", title: "Welcome", question: "What is the history refresh hour still for?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 1, label: "How to Use", title: "How to Use This Book This Week", question: "What can you run on a Tuesday?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 2, label: "Five Things", title: "If You Only Remember Five Things", question: "What must hold if the rest is ignored?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 3, label: "The Hour", title: "The History Refresh Hour", question: "What does a session of usable looking actually look like?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 4, label: "Chapter 1", title: "What civic literacy looks like for adults", question: "Is a job a civic bicycle?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 5, label: "Chapter 2", title: "Reading a primary", question: "Can you open the piece before the feed?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 6, label: "Chapter 3", title: "Feed vs primary", question: "Is a caption the event?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 7, label: "Chapter 4", title: "Two accounts and corroboration", question: "Is one account a verdict?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 8, label: "Chapter 5", title: "Civic texts as documents", question: "Is a founding phrase a slogan, or a maker’s sentence?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 9, label: "Chapter 6", title: "Context, maps, and timelines on the go", question: "Does the map serve today’s piece?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 10, label: "Chapter 7", title: "Talking and writing a short civic claim", question: "Does the claim name a source and a limit?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 11, label: "Chapter 8", title: "Keeping track", question: "What still has to leave the house?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
    { number: 12, label: "Chapter 9", title: "Resources", question: "Which program fits this hour, and which does not?", voices: ["parent-teacher"], wordTarget: "complete", status: "complete" },
  ],
};
...
export const books: Book[] = [
  ...
  historyForLittleThinkersBook,
  historyForYoungMindsBook,
  historyForEmergingAdultsBook,
  historyRefreshForAdultsBook,
  ...
  englishForYoungThinkersWithDyslexiaBook,
  englishForYoungMindsWithDyslexiaBook,
